...
export const EditMellis  = () => {
    ...
    useEffect(() => {
        const getImgById = async () => {
            try {
                const respuesta = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/mellisImg/${id}`);  // URL específica
    ...
    const update = async (e) => {
        ...
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}/mellisImg/${id}`, formData, {
                headers: {
